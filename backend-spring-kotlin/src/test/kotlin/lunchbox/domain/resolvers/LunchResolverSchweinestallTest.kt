...
class LunchResolverSchweinestallTest {
  ...
  fun `resolve offers for week of 2020-01-13`() {
    ...
    offers shouldContain LunchOffer(
      ...
      "auf Petersiliensauce mit Salzkartoffeln",
      week.monday,
      euro("6.10"),
      emptySet(),
      providerId,
    ...
    offers shouldContain LunchOffer(
      ...
      "mit Tsatsiki und Pommes frites",
      week.tuesday,
      euro("6.10"),
      emptySet(),
      providerId,
    ...
    offers shouldContain LunchOffer(
      0,
      "Königsberger Klopse",
      "mit Salzkartoffeln und Rote Bete",
      week.thursday,
      euro("5.60"),
      emptySet(),
      providerId,
    ...
    offers shouldContain LunchOffer(
      ...
      "mit Blattspinat, Tomate und Hirtenkäse überbacken, dazu Reis",
      week.tuesday,
      euro("5.60"),
      emptySet(),
      providerId,
    ...
    offers shouldContain LunchOffer(
      0,
      "Hähnchenbrustfilet",
      "auf mexikanischer Gemüsesauce mit Kartoffelspalten",
      week.wednesday,
      euro("6.10"),
      emptySet(),
      providerId,
  ...
  fun `resolve offers for week of 2020-02-10`() {
    ...
    offers shouldContain LunchOffer(
      0,
      "Pangasiusfilet",
      "mit Champignons und Paprika überbacken, dazu Pommes frites",
      week.monday,
      euro("6.10"),
      emptySet(),
      providerId,
