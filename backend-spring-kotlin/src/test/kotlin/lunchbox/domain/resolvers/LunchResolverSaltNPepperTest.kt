...
class LunchResolverSaltNPepperTest {
  ...
  fun `resolve offers for week of 2015-06-19`() {
    ...
    offers shouldContain LunchOffer(
      0,
      "Hähnchenkeule",
      "in Curry-Mango-Rahm, frische Buttermöhren, Kartoffeln",
      week.monday,
      euro("5.20"),
      emptySet(),
      providerId
    ...
    offers shouldContain LunchOffer(
      0,
      "Putenstreifen",
      "mit Pilzen in Käsesahnesauce auf Spaghetti",
      week.monday,
      euro("5.70"),
      emptySet(),
      providerId
    ...
    offers shouldContain LunchOffer(
      0,
      "Rumpsteak (180gr.)",
      "Grillbutter, Pommes frites, Salatbeilage",
      week.monday,
      euro("6.90"),
      setOf("Wochenangebot"),
      providerId
    ...
    offers shouldContain LunchOffer(
      0,
      "Putenleber",
      "hausgemachter Apfelrotkohl, hausgemachtes Kartoffelpüree",
      week.tuesday,
      euro("5.20"),
      emptySet(),
      providerId
    ...
    offers shouldContain LunchOffer(
      0,
      "Gefüllte Schnitzel „Cordon bleu“",
      "mediterranem Gemüsegratin",
      week.tuesday,
      euro("5.70"),
      emptySet(),
      providerId
    ...
    offers shouldContain LunchOffer(
      ...
      "auf Bandnudeln, Spinat-Käse-Sauce",
      week.wednesday,
      euro("5.70"),
      emptySet(),
      providerId
    ...
    offers shouldContain LunchOffer(
      0,
      "Thai Suppe",
      "mit Hühnerfleisch und Frischem Koriander",
      week.thursday,
      euro("3.90"),
      emptySet(),
      providerId
    ...
    offers shouldContain LunchOffer(
      ...
      "auf gebratenen Asianudeln, Kokos-Sauce",
      week.thursday,
      euro("5.20"),
      emptySet(),
      providerId
    ...
    offers shouldContain LunchOffer(
      0,
      "Paprika-Gulasch oder Champignon-Gulasch",
      "mit Nudeln Sauerrahm",
      week.thursday,
      euro("5.70"),
      emptySet(),
      providerId
    ...
    offers shouldContain LunchOffer(
      0,
      "2 Eier",
      "Senfsauce, Buttergemüse, Kartoffeln, 1 Dessert",
      week.thursday,
      euro("4.90"),
      emptySet(),
      providerId
    ...
    offers shouldContain LunchOffer(
      0,
      "Kasslersteak",
      "mit Pommes frites und Weißkrautsalat",
      week.friday,
      euro("5.70"),
      emptySet(),
      providerId
  ...
  fun `resolve offers for week of 2015-08-10`() {
    ...
    offers shouldContain LunchOffer(
      0,
      "Gefülltes Schnitzel „Toskaner Art“",
      "mit Tomatensalat und Pommes frites",
      week.tuesday,
      euro("5.70"),
      emptySet(),
      providerId
    ...
    offers shouldContain LunchOffer(
      0,
      "Gefülltes Schnitzel „Cordon bleu“",
      "mit buntem Krautsalat und Pommes frites",
      week.wednesday,
      euro("5.70"),
      emptySet(),
      providerId
    ...
    offers shouldContain LunchOffer(
      0,
      "Hacksteak „Toskana“",
      "mit mediterraner Gemüsepfanne dazu Pommes frites",
      week.friday,
      euro("5.20"),
      emptySet(),
      providerId
  ...
  fun `resolve offers for week of 2016-04-12`() {
    ...
    offers shouldContain LunchOffer(
      0,
      "Bunter Salat",
      "mit frischen Erdbeeren, gebratenem Hähnchenfleisch und hausgemachtem Erdbeer-Minze-Joghurt-Dressing",
      date("2016-04-11"),
      euro("5.90"),
      setOf("Wochenangebot"),
      providerId
  ...
  fun `resolve offers for week of 2019-03-11`() {
    ...
    offers shouldContain LunchOffer(
      0,
      "Linseneintopf",
      "mit gebratenen Wiener Würstchenscheiben (für Vegetarier extra)",
      date("2019-03-11"),
      euro("3.50"),
      emptySet(),
      providerId
    ...
    offers shouldContain LunchOffer(
      0,
      "frischer Blumenkohl",
      "mit sc. Hollandaise und Kartoffeln",
      date("2019-03-11"),
      euro("5.90"),
      setOf("vegetarisch"),
      providerId
  ...
  fun `resolve offers for week of 2019-09-09`() {
    ...
    offers shouldContain LunchOffer(
      0,
      "Lammbraten",
      "mit Speckbohnen und Petersilienkartoffeln",
      date("2019-09-10"),
      euro("6.30"),
      emptySet(),
      providerId
