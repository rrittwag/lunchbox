...
class LunchResolverSuppenkulttourSpec extends FlatSpec with Matchers with MockFactory {
  ...
  it should "resolve offers for week of 2016-06-20" in {
    ...
    offers.filter(_.day == date("2016-06-20")) should have size 4
    offers.filter(_.day == date("2016-06-21")) should have size 4
    offers.filter(_.day == date("2016-06-22")) should have size 4
    offers.filter(_.day == date("2016-06-23")) should have size 4
    offers.filter(_.day == date("2016-06-24")) should have size 4

    offers should contain (LunchOffer(0, "Pasta Bavaria: Gabelspaghetti mit original bayrischem Wurstgulach", date("2016-06-21"), euro("4.50"), Id))
  }
  ...
  it should "resolve offers for week of 2016-06-27" in {
    ...
    offers.filter(_.day == date("2016-06-27")) should have size 4
    offers.filter(_.day == date("2016-06-28")) should have size 4
    offers.filter(_.day == date("2016-06-29")) should have size 4
    offers.filter(_.day == date("2016-06-30")) should have size 4
  ...
  it should "resolve offers for week of 2017-09-04" in {
    ...
    offers.filter(_.day == date("2017-09-04")) should have size 4
    offers.filter(_.day == date("2017-09-05")) should have size 4
    offers.filter(_.day == date("2017-09-06")) should have size 4
  ...
  it should "resolve offers for week of 2019-06-10" in {
    val url = getClass.getResource("/mittagsplaene/suppenkulttour/2019-06-10.html")

    val offers = resolver.resolve(url)

    offers.filter(_.day == date("2019-06-10")) should have size 0
    offers.filter(_.day == date("2019-06-11")) should have size 4
    offers.filter(_.day == date("2019-06-12")) should have size 4
    offers.filter(_.day == date("2019-06-13")) should have size 4
    offers.filter(_.day == date("2019-06-14")) should have size 4

    offers should contain (LunchOffer(0, "Pasta „Pollo“ (enthält: Huhn, Möhren, Zucchini, Cherrytomaten in einer cremigen Tomatensoße, verfeinert mit Olivenöl, Frischkäse, Mozzarella, Basilikum, Thymian", date("2019-06-11"), euro("4.70"), Id))
  }
